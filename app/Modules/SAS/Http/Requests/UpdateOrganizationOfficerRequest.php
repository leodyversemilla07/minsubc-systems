...
class UpdateOrganizationOfficerRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('update organization officers');
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'is_current.boolean' => 'The is current field must be true or false.',
        ];
    }
}
