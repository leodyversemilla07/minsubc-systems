...
use Modules\Registrar\Http\Requests\ConfirmCashPaymentRequest;
use Modules\Registrar\Http\Requests\VerifyPaymentReferenceRequest;
...
class PaymentController extends Controller
{
    ...
    /**
     * Handle successful payment return (only for cash payments)
     */
    ...
    public function confirmCashPayment(ConfirmCashPaymentRequest $request): JsonResponse
    {
        ...
        $this->notificationService->notifyPaymentConfirmed($payment->documentRequest);
