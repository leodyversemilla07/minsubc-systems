...
use Modules\Registrar\Enums\DocumentType;
use Modules\Registrar\Http\Requests\ConfirmClaimRequest;
use Modules\Registrar\Http\Requests\StoreDocumentRequest;
