...
enum DocumentRequestStatus: string
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::Processing => 'Registrar staff is currently working on the document using their own software. Document is being prepared.',
            self::ReadyForClaim => 'Document has been prepared by registrar and is ready. Student can schedule pickup or claim the document.',
