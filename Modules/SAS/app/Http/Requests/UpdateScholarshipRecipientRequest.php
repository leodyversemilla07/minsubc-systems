...
class UpdateScholarshipRecipientRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('update scholarship recipients');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'renewal_status' => ['required', Rule::in(['Not Applicable', 'Pending', 'Approved', 'Denied'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'renewal_status.required' => 'The renewal status is required.',
            'renewal_status.in' => 'The selected renewal status is invalid.',
            'requirements_complete.boolean' => 'The requirements complete field must be true or false.',
        ];
    }
}
