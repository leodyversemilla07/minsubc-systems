...
use Modules\SAS\Http\Requests\StoreSASActivityRequest;
use Modules\SAS\Http\Requests\UpdateSASActivityRequest;
...
class ActivityController extends Controller
{
    ...
    {
        $organizations = \Modules\SAS\Models\Organization::where('status', 'Active')->get();
