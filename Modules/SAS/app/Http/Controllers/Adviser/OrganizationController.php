...
namespace Modules\SAS\Http\Controllers\Adviser;
...
use Modules\SAS\Http\Requests\StoreOrganizationOfficerRequest;
use Modules\SAS\Http\Requests\UpdateOrganizationOfficerRequest;
...
class OrganizationController extends Controller
{
    ...
    public function uploadDocument(Request $request): RedirectResponse
    {
        ...
        \Modules\SAS\Models\OrganizationDocument::create([
