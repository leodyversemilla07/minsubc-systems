            ...
            <nav className="fixed top-0 right-0 left-0 z-50 border-b border-green-200 bg-white shadow-sm backdrop-blur-md dark:border-gray-800 dark:bg-gray-900">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex h-16 items-center justify-between">
                        <Link
                            href={usg.index.url()}
                            className="flex items-center gap-3 transition-all hover:opacity-80 focus:rounded-md focus:ring-2 focus:ring-[var(--usg-primary)] focus:ring-offset-2 focus:outline-none"
                        >
                            <img
                                src="/minsu-logo.png"
                                alt="MinSUBC Logo"
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button
                                variant="ghost"
                                className="group relative h-10 w-10 text-gray-600 hover:bg-green-50 hover:text-green-900 sm:h-10 sm:w-auto sm:min-w-[180px] sm:justify-start sm:px-4 sm:pr-12 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white"
                            ...
                            >
                                ...
                                <Kbd className="absolute top-1/2 right-2.5 hidden -translate-y-1/2 sm:flex">
                            ...
                            {auth.user ? (
                                <Link
                                    href={dashboard()}
                                    className="hidden rounded-lg bg-green-700 px-4 py-2 text-sm font-medium text-white shadow-md transition-all hover:bg-green-800 hover:shadow-lg focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none sm:block"
                                >
                                    Dashboard
                                </Link>
                            ) : (
                                <>
                                    <Link
                                        href={login()}
                                        className="hidden px-4 py-2 text-sm font-medium text-green-900 transition-all hover:text-green-800 focus:rounded-md focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none sm:block dark:text-gray-300 dark:hover:text-white"
                                    >
                                        Log in
                                    </Link>
                                    <Link
                            ...
                            {navigationLinks.map((link) => {
                                ...
                                return (
                                    <Link
                                        key={link.href}
                                        href={link.href}
                                        className={`rounded-md px-4 py-2 text-sm font-medium transition-all focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none ${
                                            active
