...
export function CategoryFilter({
    ...
    return (
        <div
            className={`flex flex-col items-start gap-4 sm:flex-row sm:items-center ${className}`}
        >
            {/* Search Input */}
