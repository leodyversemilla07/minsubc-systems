...
const navigationLinks = [
    ...
    { href: sas.student.scholarships.index.url(), label: 'Scholarships' },
    { href: sas.student.insurance.index.url(), label: 'Insurance' },
    ...
    { href: sas.admin.dashboard.url(), label: 'Reports' },
];
