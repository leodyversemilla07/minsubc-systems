 ...
 * @route '/sas/admin/renewals/{recipientId}/create'
 */
    const createForm = (args: { recipientId: string | number } | [recipientId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/sas/admin/renewals/{recipientId}/create'
 */
        createForm.post = (args: { recipientId: string | number } | [recipientId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: create.url(args, options),
            method: 'post',
        })
