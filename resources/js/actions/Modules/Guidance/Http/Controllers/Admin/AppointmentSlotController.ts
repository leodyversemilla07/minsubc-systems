...
/**
* @see \Modules\Guidance\Http\Controllers\Admin\AppointmentSlotController::availableSlots
...
const AppointmentSlotController = { index, create, store, show, destroy, availableSlots }

export default AppointmentSlotController