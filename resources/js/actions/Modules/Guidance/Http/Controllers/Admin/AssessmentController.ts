...
/**
* @see \Modules\Guidance\Http\Controllers\Admin\AssessmentController::printReport
 ...
 */
export const printReport = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: printReport.url(args, options),
    method: 'get',
})
 ...
 * @route '/guidance/admin/assessments/{assessment}/print'
 */
printReport.url = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { assessment: args }
    }
    ...
    return printReport.definition.url
            .replace('{assessment}', parsedArgs.assessment.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/guidance/admin/assessments/{assessment}/print'
 */
printReport.get = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: printReport.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/guidance/admin/assessments/{assessment}/print'
 */
printReport.head = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: printReport.url(args, options),
    method: 'head',
})
 ...
 * @route '/guidance/admin/assessments/{assessment}/print'
 */
    const printReportForm = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: printReport.url(args, options),
        method: 'get',
    })
 ...
 * @route '/guidance/admin/assessments/{assessment}/print'
 */
        printReportForm.get = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: printReport.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/guidance/admin/assessments/{assessment}/print'
 */
        printReportForm.head = (args: { assessment: string | number } | [assessment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: printReport.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
...
const AssessmentController = { index, show, review, printReport }
