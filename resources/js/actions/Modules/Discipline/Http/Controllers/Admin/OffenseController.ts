 ...
 */
const index0640c4983b94ad41074733268116fa36 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index0640c4983b94ad41074733268116fa36.url(options),
    method: 'get',
})

index0640c4983b94ad41074733268116fa36.definition = {
    methods: ["get","head"],
 ...
 * @route '/admin/discipline/offenses'
 */
index0640c4983b94ad41074733268116fa36.url = (options?: RouteQueryOptions) => {
    return index0640c4983b94ad41074733268116fa36.definition.url + queryParams(options)
}
 ...
 * @route '/admin/discipline/offenses'
 */
index0640c4983b94ad41074733268116fa36.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index0640c4983b94ad41074733268116fa36.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin/discipline/offenses'
 */
index0640c4983b94ad41074733268116fa36.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: index0640c4983b94ad41074733268116fa36.url(options),
    method: 'head',
})
 ...
 * @route '/admin/discipline/offenses'
 */
    const index0640c4983b94ad41074733268116fa36Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: index0640c4983b94ad41074733268116fa36.url(options),
        method: 'get',
    })
 ...
 * @route '/admin/discipline/offenses'
 */
        index0640c4983b94ad41074733268116fa36Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: index0640c4983b94ad41074733268116fa36.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/discipline/offenses'
 */
        index0640c4983b94ad41074733268116fa36Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: index0640c4983b94ad41074733268116fa36.url({
    ...
    index0640c4983b94ad41074733268116fa36.form = index0640c4983b94ad41074733268116fa36Form
    /**
* @see \Modules\Discipline\Http\Controllers\Admin\OffenseController::index
 * @see Modules/Discipline/app/Http/Controllers/Admin/OffenseController.php:11
 * @route '/api/discipline/discipline/offenses'
 */
const index3e167dfeb20da87a7ce94879294221a0 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index3e167dfeb20da87a7ce94879294221a0.url(options),
    method: 'get',
})

index3e167dfeb20da87a7ce94879294221a0.definition = {
    methods: ["get","head"],
 ...
 * @route '/api/discipline/discipline/offenses'
 */
index3e167dfeb20da87a7ce94879294221a0.url = (options?: RouteQueryOptions) => {
    return index3e167dfeb20da87a7ce94879294221a0.definition.url + queryParams(options)
}
 ...
 * @route '/api/discipline/discipline/offenses'
 */
index3e167dfeb20da87a7ce94879294221a0.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index3e167dfeb20da87a7ce94879294221a0.url(options),
    method: 'get',
})
/**
 ...
 * @route '/api/discipline/discipline/offenses'
 */
index3e167dfeb20da87a7ce94879294221a0.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: index3e167dfeb20da87a7ce94879294221a0.url(options),
    method: 'head',
})
 ...
 * @route '/api/discipline/discipline/offenses'
 */
    const index3e167dfeb20da87a7ce94879294221a0Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: index3e167dfeb20da87a7ce94879294221a0.url(options),
        method: 'get',
    })
 ...
 * @route '/api/discipline/discipline/offenses'
 */
        index3e167dfeb20da87a7ce94879294221a0Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: index3e167dfeb20da87a7ce94879294221a0.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/discipline/discipline/offenses'
 */
        index3e167dfeb20da87a7ce94879294221a0Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: index3e167dfeb20da87a7ce94879294221a0.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    index3e167dfeb20da87a7ce94879294221a0.form = index3e167dfeb20da87a7ce94879294221a0Form

export const index = {
    '/admin/discipline/offenses': index0640c4983b94ad41074733268116fa36,
    '/api/discipline/discipline/offenses': index3e167dfeb20da87a7ce94879294221a0,
}
...
const OffenseController = { index, store, update, destroy }

export default OffenseController