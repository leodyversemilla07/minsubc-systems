    ...
    return (
        <SASLayout>
            <Head>
                ...
                <meta
                    name="description"
                    content="Manage student insurance records and claims at MinSU Bongabong Campus"
                />
            </Head>
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mb-8 max-w-3xl text-lg leading-relaxed text-gray-600 sm:text-xl lg:text-2xl dark:text-gray-300">
                            ...
                            forms, claims, and coverage tracking for MinSU
                            Bongabong Campus students
                        </p>
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                            Comprehensive insurance options available to MinSU
                            Bongabong Campus students
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Health insurance coverage for illnesses,
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                24/7 personal accident coverage including death
            ...
            <section className="bg-blue-50 px-4 py-20 sm:px-6 lg:px-8 dark:bg-gray-900">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                            Simple and efficient process for filing insurance
                            claims
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Notify the insurance office immediately about
                                any covered incidents.
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Collect all necessary medical reports, receipts,
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Complete the online claim form and upload all
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Monitor claim status and receive payment once
                                approved.
                            </p>
                        </div>
                    </div>
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <Card className="cursor-pointer rounded-xl border border-gray-200 p-6 text-center transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">
                                Get help with insurance matters
                            </p>
                        </Card>
                    </div>
                </div>
