            ...
            <div className="flex-1 space-y-6 p-4 md:space-y-8 md:p-6 lg:p-8">
                ...
                <div className="grid gap-4 md:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {
                                    scholarships.data.filter((s) => s.is_active)
                                        .length
                                }
                            </div>
                        </CardContent>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {scholarships.data.reduce(
                                    (sum, s) =>
                                        sum + Number(s.recipients_count || 0),
                                    0,
                                )}
                            </div>
                        </CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Search and filter scholarship programs
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                                ...
                                                (scholarship) => (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="text-right font-medium">
                                                            ₱
                                                            {scholarship.total_amount.toLocaleString()}
                                                        </TableCell>
                                                        <TableCell className="text-center">
                                ...
                                {scholarships.last_page > 1 && (
                                    <div className="mt-4 flex items-center justify-between">
                                        <div className="text-sm text-muted-foreground">
                                            Showing {scholarships.data.length}{' '}
                                            of {scholarships.total} results
                                        </div>
