...
export default function CreateActivity({ organizations }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(sas.admin.activities.store.url());
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Create Activity', href: sas.admin.activities.create.url() },
            ]}
        >
                    ...
                    <div className="flex items-center gap-4">
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground sm:text-base">
                                Add a new SAS activity or event
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Enter the core details for the activity
                            </CardDescription>
                        </CardHeader>
