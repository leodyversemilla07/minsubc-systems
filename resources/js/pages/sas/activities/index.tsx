...
export default function ActivitiesIndex({ activities, filters }: Props) {
    ...
    const filteredActivities = activities.data.filter((activity) => {
        ...
        const matchesType =
            typeFilter === 'all' || (activity.category || '') === typeFilter;
        const matchesStatus =
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        router.get(
            index({
                query: { search, type: typeFilter, status: statusFilter },
            }),
            { preserveState: true },
        );
    };
    ...
    const handleFilterChange = (key: string, value: string) => {
        ...
        router.get(index({ query: newFilters }), { preserveState: true });
    };
            ...
            <section className="relative overflow-hidden border-b border-slate-200/70 bg-[radial-gradient(circle_at_top_right,rgba(34,197,94,0.18),transparent_34%),linear-gradient(135deg,#f8fafc_0%,#ecfdf5_45%,#f8fafc_100%)] px-4 py-14 text-slate-900 sm:px-6 sm:py-16 lg:px-8 dark:border-slate-800 dark:bg-[radial-gradient(circle_at_top_right,rgba(34,197,94,0.22),transparent_34%),linear-gradient(135deg,#020617_0%,#03130c_48%,#020617_100%)] dark:text-white">
                ...
                <div className="relative mx-auto max-w-7xl px-4 text-center">
                    ...
                    <p className="mx-auto mb-8 max-w-2xl text-lg text-slate-600 dark:text-slate-300">
                        ...
                        organized by Student Affairs and various student
                        organizations.
                    </p>
                    ...
                    <div className="mb-10 flex flex-wrap justify-center gap-4">
                        <Link href={calendar()}>
                            <Button
                                ...
                                className="gap-2"
                            >
                                <Calendar className="h-5 w-5" /> Monthly
                                Calendar
                            </Button>
                        </Link>
                        <Link href="/sas/activities/yearly-timeline">
                            <Button
                                ...
                                className="gap-2"
                            >
                                <CalendarDays className="h-5 w-5" /> Yearly
                                Timeline
                            </Button>
                        </Link>
                        <a
                        ...
                        >
                            <Button
                                variant="outline"
                                size="lg"
                                className="gap-2 border-slate-300 text-slate-600 hover:bg-slate-50 dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-800"
                            >
                            ...
                            >
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        ...
                                        variant="secondary"
                                        size="lg"
                                        className={`h-12 border-0 bg-slate-100 px-4 text-slate-700 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 ${showFilters ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : ''}`}
                                        onClick={() =>
                    ...
                    {filteredActivities.length > 0 ? (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <div className="mb-2 flex items-center gap-2">
                                            <Badge
                                                variant="outline"
                                                className="rounded bg-blue-50 px-2 py-0.5 text-xs font-bold tracking-wider text-blue-600 uppercase dark:bg-blue-900/20 dark:text-blue-400"
                                            >
                                    ...
                                    <Link
                                        ...
                                        className="mt-6 flex items-center gap-2 text-sm font-bold text-green-700 transition-all group-hover:gap-3 group-hover:text-green-800 dark:text-green-400 dark:group-hover:text-green-300"
                                    >
                                        View Details
                        ...
                        <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-300 bg-white/80 px-4 py-16 text-center shadow-sm backdrop-blur dark:border-slate-700 dark:bg-slate-950/60">
                            ...
                            <p className="mb-6 max-w-md text-slate-600 dark:text-slate-400">
                                We couldn't find any activities matching your
