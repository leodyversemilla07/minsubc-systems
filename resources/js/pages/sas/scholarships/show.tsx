...
export default function ScholarshipShow({
    ...
    return (
        <SASLayout>
            ...
            {/* Header */}
            <section className="relative overflow-hidden border-b border-green-100 bg-gradient-to-br from-white via-green-50/50 to-white px-4 py-12 text-slate-900 sm:px-6 lg:px-8 dark:border-slate-800 dark:from-slate-950 dark:via-green-950/20 dark:to-slate-950 dark:text-white">
                {/* Background Pattern */}
                    ...
                    <div className="flex flex-col gap-6 md:flex-row md:items-start lg:gap-8">
                        ...
                        <div className="flex-shrink-0">
                            <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-green-100 to-emerald-200 shadow-xl md:h-24 md:w-24 dark:from-green-900 dark:to-green-800">
                                <GraduationCap className="h-10 w-10 text-green-700 md:h-12 md:w-12 dark:text-green-300" />
                            </div>
                        </div>
                        ...
                        <div className="flex-1">
                            <div className="mb-3 flex flex-wrap items-center gap-3">
                                <span className="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-bold tracking-wider text-blue-700 uppercase dark:border-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                                ...
                                {scholarship.is_active && (
                                    <span className="inline-flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-3 py-1 text-xs font-bold tracking-wider text-green-700 uppercase dark:border-green-800 dark:bg-green-900/30 dark:text-green-400">
                                        ...
                                        <div className="grid gap-4 sm:grid-cols-2">
                                            {relatedScholarships.map(
                                                (related) => (
                                                    ...
                                                    >
                                                        {/* Top Gradient Line */}
                                                        <div className="absolute top-0 left-0 h-1 w-full bg-gradient-to-r from-green-500 to-emerald-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>

                                                        <h4 className="font-bold text-slate-900 transition-colors group-hover:text-green-700 dark:text-white dark:group-hover:text-green-400">
                                                            {
                                                        ...
                                                        <div className="mt-4 flex -translate-x-2 items-center text-xs font-bold text-green-600 opacity-0 transition-all group-hover:translate-x-0 group-hover:opacity-100 dark:text-green-400">
                                                            View Details{' '}
                            ...
                            <div className="sticky top-6 space-y-6">
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        {scholarship.is_active ? (
                                            <div className="rounded-xl border border-green-100 bg-green-50 p-4 text-center dark:border-green-900/50 dark:bg-green-900/20">
                                        ...
                                        <button className="inline-flex items-center justify-center rounded-xl border border-transparent bg-gradient-to-r from-green-600 to-green-700 px-8 py-3 text-lg font-medium text-white shadow-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-green-500/30 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50">
                                            Apply Now
                                        </button>
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-800/50">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <div className="inline-block rounded border border-slate-200 bg-white px-2 py-1 font-mono text-sm font-medium text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-white">
                                                {scholarship.scholarship_code}
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div className="mt-6 border-t border-slate-200 pt-6 dark:border-slate-700">
                                        ...
                                        <a
                                            ...
                                            className="flex items-center gap-1 text-sm font-bold text-green-600 hover:text-green-700 dark:text-green-400"
                                        >
