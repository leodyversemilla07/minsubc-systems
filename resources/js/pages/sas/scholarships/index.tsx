    ...
    return (
        <SASLayout>
            <Head>
                ...
                <meta
                    name="description"
                    content="Manage and track student scholarships at MinSU Bongabong Campus"
                />
            </Head>
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mb-8 max-w-3xl text-lg leading-relaxed text-gray-600 sm:text-xl lg:text-2xl dark:text-gray-300">
                            ...
                            including applications, tracking, and reporting for
                            MinSU Bongabong Campus students
                        </p>
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                            Explore various scholarship opportunities available
                            to MinSU Bongabong Campus students
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Tertiary Education Subsidy for qualified
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Tulong Dunong Program for students with
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Academic excellence awards for outstanding
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Institutional scholarships funded by MinSU
                                Bongabong Campus endowment.
                            </p>
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium text-blue-700 dark:text-blue-400">
                                    Up to ₱25,000/year
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Athletic excellence awards for student-athletes
                        ...
                        <Card className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Support for students actively participating in
            ...
            <section className="bg-blue-50 px-4 py-20 sm:px-6 lg:px-8 dark:bg-gray-900">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                            Simple steps to apply for scholarships at MinSU
                            Bongabong Campus
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                ...
                                for your chosen scholarship program.
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Monitor your application status and receive
