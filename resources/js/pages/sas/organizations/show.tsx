            ...
            <section className="relative overflow-hidden border-b border-green-100 bg-gradient-to-br from-white via-green-50/50 to-white pt-8 pb-12 dark:border-gray-800 dark:from-gray-900 dark:via-green-950/20 dark:to-gray-900">
                ...
                <div className="relative mx-auto max-w-7xl px-4">
                    ...
                    <Link
                        ...
                        className="mb-8 inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition-colors hover:text-green-700 dark:text-gray-400 dark:hover:text-green-400"
                    >
                    ...
                    <div className="flex flex-col gap-6 md:flex-row md:items-start lg:gap-8">
                        ...
                        <div className="flex-shrink-0">
                            <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-green-100 to-emerald-200 shadow-xl ring-4 ring-white md:h-32 md:w-32 dark:from-green-900 dark:to-green-800 dark:ring-gray-900">
                                {organization.logo_path ? (
                                    ...
                                    <Users className="h-12 w-12 text-green-700 md:h-16 md:w-16 dark:text-green-300" />
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-1">
                            ...
                            <h1 className="mb-4 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-white">
                                    ...
                                    organization.officers.length > 0 ? (
                                        <div className="grid gap-4 sm:grid-cols-2">
                                            {currentOfficers.map((officer) => (
                                                <div
                                                    key={officer.id}
                                                    className="flex items-start gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-green-300 hover:shadow-md dark:border-gray-700 dark:bg-gray-900 dark:hover:border-green-700"
                                                >
                            ...
                            <div className="lg:col-span-1">
                                <div className="sticky top-24 space-y-6">
                                    ...
                                    {organization.adviser && (
                                        <Card className="rounded-2xl border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
                                            <CardHeader>
                                                <CardTitle className="text-sm font-bold tracking-wider text-gray-500 uppercase dark:text-gray-400">
                                                    Organization Adviser
                                                </CardTitle>
                                            </CardHeader>
                                            <CardContent>
                                    ...
                                    <Card className="rounded-2xl border-gray-200 bg-gray-50 shadow-sm dark:border-gray-700 dark:bg-gray-800/50">
                                        ...
                                        <CardContent>
                                            <div className="grid grid-cols-3 gap-2 text-center">
                                                <div className="rounded-xl border border-gray-100 bg-white p-2 shadow-sm dark:border-gray-700 dark:bg-gray-900">
