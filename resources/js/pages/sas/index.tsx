        ...
        <div className="relative mx-auto max-w-7xl">
            <div className="text-center">
                ...
                <p className="mx-auto mb-8 max-w-3xl text-lg leading-relaxed text-gray-600 sm:text-xl lg:text-2xl dark:text-gray-300">
                    ...
                    <span className="font-semibold text-blue-700 dark:text-blue-400">scholarships</span>, and fostering{' '}
                    <span className="font-semibold text-blue-700 dark:text-blue-400">organizational excellence</span> at MinSU Bongabong Campus
                </p>
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8 dark:bg-gray-800">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
              ...
              <Link href="#" className="font-medium text-blue-700 hover:text-blue-800 dark:text-blue-400">
                View Scholarships →
              </Link>
            </div>
