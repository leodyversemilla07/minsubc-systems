    ...
    return (
        <SASLayout>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/50 to-white px-4 py-24 sm:px-6 lg:px-8 dark:from-gray-900 dark:via-blue-950/30 dark:to-gray-900">
                ...
                <div className="pointer-events-none absolute top-1/2 right-1/3 h-72 w-72 animate-pulse rounded-full bg-gradient-to-bl from-blue-200/20 to-transparent blur-2xl [animation-delay:4s] dark:from-blue-800/10" />
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="text-center">
                        ...
                        {/* Main Heading */}
                        <h1 className="mb-8 animate-[fade-in_1.2s_ease-out] bg-gradient-to-br from-gray-900 via-blue-800 to-blue-600 bg-clip-text text-5xl leading-tight font-black text-transparent sm:text-6xl lg:text-8xl dark:from-white dark:via-blue-200 dark:to-blue-400">
                            Student Affairs
                            <br />
                        ...
                        <div className="flex animate-[fade-in_1.6s_ease-out] flex-col items-center justify-center gap-4 sm:flex-row">
                            <Link href={sas.scholarships.index.url()}>
                                <Button
                                    size="lg"
                                    className="group relative inline-flex items-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-4 text-base font-bold text-white shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-600/40"
                                >
                            ...
                            <Link href={sas.organizations.index.url()}>
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="group inline-flex items-center gap-2 overflow-hidden rounded-xl border-2 border-blue-600 bg-white px-8 py-4 text-base font-bold text-blue-700 shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-700 hover:bg-blue-50 hover:shadow-2xl dark:border-blue-500 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700"
                                >
            ...
            {/* Stats Section */}
            <div className="relative bg-gradient-to-b from-white via-blue-50/30 to-white px-4 pt-8 pb-12 dark:from-gray-900 dark:via-blue-950/20 dark:to-gray-900">
                <div className="mx-auto -mt-20 grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-6">
                    <div className="group relative overflow-hidden rounded-2xl border border-blue-200/50 bg-white/90 p-6 shadow-xl backdrop-blur-md transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20 dark:border-gray-700/50 dark:bg-gray-800/90">
                        <div className="absolute -top-4 -right-4 h-24 w-24 rounded-full bg-blue-500/10 blur-2xl transition-all duration-300 group-hover:bg-blue-500/20" />
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-gray-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-blue-300 hover:shadow-2xl hover:shadow-blue-500/10 dark:border-gray-700/50 dark:bg-gray-800/90 dark:hover:border-blue-600">
                            <div className="absolute -top-8 -right-8 h-32 w-32 rounded-full bg-gradient-to-br from-blue-500/20 to-transparent blur-2xl transition-all duration-300 group-hover:scale-150" />
                            <div className="relative">
