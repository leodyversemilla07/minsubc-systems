    ...
    return (
        <SASLayout>
            <Head>
                ...
                <meta
                    name="description"
                    content="Student Affairs System (SAS) - Managing student services, scholarships, insurance, and organizational records"
                />
            </Head>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Track and manage various scholarship programs
                        ...
                        <div className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Manage records for all student organizations and
                                their activities.
                            </p>
                            <Link
                                href="#"
                        ...
                        <div className="rounded-xl border border-gray-200 p-6 transition-all hover:border-blue-300 hover:shadow-lg dark:border-gray-700 dark:hover:border-blue-600">
                            ...
                            <p className="mb-4 text-gray-600 dark:text-gray-300">
                                Schedule and track student affairs events and
                                activities.
                            </p>
                            <Link
                                href="#"
