        ...
        <SASLayout>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-white via-green-50/50 to-white pt-8 sm:pt-48 pb-24 sm:px-6 lg:px-8 dark:from-slate-950 dark:via-green-950/20 dark:to-slate-950">
                ...
                <div className="relative mx-auto max-w-7xl px-4 text-center">
                    ...
                    <h1 className="mb-8 animate-[fade-in_1.2s_ease-out] bg-gradient-to-br from-slate-900 via-green-800 to-green-600 bg-clip-text text-5xl leading-tight font-black text-transparent sm:text-6xl lg:text-8xl dark:from-white dark:via-green-200 dark:to-green-400 tracking-tight">
                        Student Affairs
                        <br />
                    ...
                    <p className="mx-auto mb-10 max-w-3xl animate-[fade-in_1.4s_ease-out] text-lg leading-relaxed text-slate-600 sm:text-xl lg:text-2xl dark:text-slate-300">
                        ...
                        <span className="font-bold text-green-700 dark:text-green-400">scholarships</span>
                        , and fostering{' '}
                        <span className="font-bold text-green-700 dark:text-green-400">organizational excellence</span>{' '}
                    ...
                    <div className="flex animate-[fade-in_1.6s_ease-out] flex-col items-center justify-center gap-4 sm:flex-row">
                        <Link href={sas.scholarships.index.url()}>
                            <Button size="lg" className="bg-gradient-to-r from-green-600 to-green-700 text-white shadow-lg hover:shadow-xl hover:shadow-green-500/30 hover:-translate-y-0.5">
                                View Scholarships
                            </Button>
                        </Link>
                        <Link href={sas.organizations.index.url()}>
                            <Button size="lg" variant="secondary" className="bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-750">
            ...
            <section className="bg-gradient-to-b from-white to-slate-50 px-4 py-20 sm:px-6 lg:px-8 dark:from-slate-900 dark:to-slate-800">
                <div className="mx-auto max-w-7xl">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/10 dark:border-slate-700/50 dark:bg-slate-800/90 dark:hover:border-green-600 flex flex-col h-full">
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <h3 className="mb-3 text-xl font-bold text-slate-900 dark:text-white group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors">
                                    Scholarship Management
                                </h3>
                                <p className="mb-5 text-slate-600 dark:text-slate-300 flex-grow leading-relaxed">
                                    Track and manage various scholarship programs including TES, TDP, and more with real-time status updates.
                                </p>
                                
                                <Link
                                    href={sas.scholarships.index.url()}
                                    className="inline-flex items-center gap-2 font-bold text-green-700 transition-all hover:gap-3 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 mt-auto cursor-pointer"
                                >
                                    View Details
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/10 dark:border-slate-700/50 dark:bg-slate-800/90 dark:hover:border-green-600 flex flex-col h-full">
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <p className="mb-5 text-slate-600 dark:text-slate-300 flex-grow leading-relaxed">
                                    Digital management of student insurance forms and records, replacing manual paperwork with secure digital filings.
                                </p>
                                
                                <div className="inline-flex items-center gap-2 font-bold text-green-700 transition-all hover:gap-3 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 mt-auto cursor-pointer">
                                    View Details
                                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/10 dark:border-slate-700/50 dark:bg-slate-800/90 dark:hover:border-green-600 flex flex-col h-full">
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <p className="mb-5 text-slate-600 dark:text-slate-300 flex-grow leading-relaxed">
                                    Manage records for all 23 student organizations, including officer rosters and activity history.
                                </p>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/10 dark:border-slate-700/50 dark:bg-slate-800/90 dark:hover:border-green-600 flex flex-col h-full">
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <p className="mb-5 text-slate-600 dark:text-slate-300 flex-grow leading-relaxed">
                                    Schedule and track student affairs events and activities with automated conflict detection.
                                </p>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/10 dark:border-slate-700/50 dark:bg-slate-800/90 dark:hover:border-green-600 flex flex-col h-full">
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <p className="mb-5 text-slate-600 dark:text-slate-300 flex-grow leading-relaxed">
                                    Centralized digital storage for all student affairs records with metadata tagging and search.
                                </p>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl transition-all duration-300 hover:scale-[1.02] hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/10 dark:border-slate-700/50 dark:bg-slate-800/90 dark:hover:border-green-600 flex flex-col h-full">
                            ...
                            <div className="relative flex flex-col h-full">
                                ...
                                <p className="mb-5 text-slate-600 dark:text-slate-300 flex-grow leading-relaxed">
                                    Generate insights from scholarship, organization, and activity data for administrative oversight.
                                </p>
