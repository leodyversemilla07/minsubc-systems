                ...
                >
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">
                                <strong>Tip:</strong> A vision statement should
                                be inspirational and describe what the
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">
                                <strong>Tip:</strong> A mission statement should
                                clearly define what the organization does and
                                who it serves.
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                long-term outcomes that support your mission.
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                specific, measurable actions that help achieve
                                your goals.
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <Card>
                            <CardContent className="p-4">
                                <Alert>
                                    <AlertCircle className="h-4 w-4" />
                                    <AlertDescription>
                                        You don't have permission to edit VMGO
                                        information. Contact an administrator if
