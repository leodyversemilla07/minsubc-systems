...
export default function EventsIndex({
    ...
    return (
        <USGLayout>
            ...
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-[var(--usg-primary)] via-[var(--usg-primary)] to-[var(--usg-dark)] py-12 text-white sm:py-16 md:py-20">
                {/* Decorative Background Pattern */}
                <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-0 left-0 h-64 w-64 rounded-full bg-white blur-3xl sm:h-80 sm:w-80 md:h-96 md:w-96"></div>
                    <div className="absolute right-0 bottom-0 h-64 w-64 rounded-full bg-white blur-3xl sm:h-80 sm:w-80 md:h-96 md:w-96"></div>
                </div>
                ...
                <div className="relative z-10 container mx-auto px-4 sm:px-6">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <p className="px-4 text-base text-[var(--usg-hero-text)] sm:text-lg md:text-xl lg:text-2xl">
                                    ...
                                    <CardContent>
                                        <div className="space-y-3 sm:space-y-4">
                                            {selectedDateEvents.map((event) => (
                                                <div
                                                    key={event.id}
                                                    className="cursor-pointer rounded-xl border border-[var(--usg-primary)] bg-gradient-to-br from-[var(--usg-light)] to-white p-3 transition-all hover:shadow-lg sm:p-4 dark:border-gray-700 dark:from-gray-800 dark:to-gray-900"
                                                    onClick={() =>
                                                ...
                                                >
                                                    {event.image_path && (
                                                        <img
                                                            ...
                                                            alt={event.title}
                                                            className="mb-2 h-20 w-full rounded-lg object-cover sm:mb-3 sm:h-24"
                                                        />
                                                    )}
                                                    <div className="line-clamp-2 text-sm font-semibold text-gray-900 sm:text-base dark:text-white">
                                                        {event.title}
                                                    </div>
                                                    <div className="mt-2 text-xs text-gray-600 sm:text-sm dark:text-gray-400">
            ...
            {/* Call to Action */}
            {upcomingEvents.length > 0 && (
                <section className="bg-[var(--usg-primary)] py-12 text-white sm:py-16 md:py-20">
                    <div className="container mx-auto px-4 sm:px-6">
                        <div className="mx-auto max-w-3xl text-center">
                            <h2 className="mb-4 text-2xl font-bold sm:mb-6 sm:text-3xl md:text-4xl">
                                Stay Connected
                            </h2>
                            <p className="mb-6 px-4 text-base text-[var(--usg-hero-text)] sm:mb-8 sm:text-lg md:text-xl">
                            ...
                            <div className="flex flex-col justify-center gap-3 px-4 sm:flex-row sm:gap-4">
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="w-full border-0 bg-white text-[var(--usg-primary)] hover:bg-[var(--usg-light)] sm:w-auto"
                                >
