                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                        ...
                        <div className="flex items-center gap-2 self-start sm:self-center">
                            <Badge variant="outline" className="gap-1 text-xs md:text-sm">
                                ...
                                <span className="hidden sm:inline">Editing Request</span>
                                ...
                                <CardContent className="space-y-3 md:space-y-4">
                                    <Alert className="text-xs md:text-sm">
                                        ...
                                        <AlertDescription className="text-xs md:text-sm">
                                            You can modify the document type, quantity, and purpose of this request.
                                            Changes will recalculate the total amount.
                                        </AlertDescription>
                                    </Alert>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="transition-shadow hover:shadow-md">
                                <CardHeader className="pb-4 md:pb-6">
                                    ...
                                    <CardDescription className="text-sm md:text-base">
                                        Modify the details of your document request
                                    </CardDescription>
                                </CardHeader>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            <TooltipTrigger asChild>
                                                                <HelpCircle className="h-3 w-3 md:h-4 md:w-4 text-muted-foreground cursor-help" />
                                                            </TooltipTrigger>
                                                            <TooltipContent>
                                                                <p className="text-xs md:text-sm">
                                                                    Select the type of document you need.
                                                                    Changing this will update the pricing.
                                                                </p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <Field>
                                                        <FieldLabel htmlFor="document_type" className="text-sm md:text-base">
                                                            Document Type *
                                                        </FieldLabel>
                                                        <Select
                                                            name="document_type"
                                                        ...
                                                        {errors.document_type && (
                                                            <FieldDescription className="text-destructive text-xs md:text-sm">
                                                                {errors.document_type}
                                                            </FieldDescription>
                                                        )}
                                                    </Field>
                                                ...
                                                <div className="space-y-3 md:space-y-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>
                                                                <p className="text-xs md:text-sm">
                                                                    Specify how many copies or pages you need.
                                                                </p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <Field>
                                                        <FieldLabel htmlFor="quantity" className="text-sm md:text-base">
                                                            Quantity *
                                                        </FieldLabel>
                                                        <Input
                                                            id="quantity"
                                                            ...
                                                            className="max-w-xs h-10 md:h-11 text-sm md:text-base"
                                                        />
                                                ...
                                                <div className="space-y-3 md:space-y-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>
                                                                <p className="text-xs md:text-sm">
                                                                    Select or specify the purpose for this document request.
                                                                </p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <Field>
                                                        <FieldLabel htmlFor="purpose" className="text-sm md:text-base">
                                                            Purpose *
                                                        </FieldLabel>
                                                        <Select
                                                            name="purpose"
                                                        ...
                                                        <FieldDescription className="text-xs md:text-sm">
                                                            Select the purpose of this document request.
                                                        </FieldDescription>
                                                        {errors.purpose && (
                                                            <FieldDescription className="text-destructive text-xs md:text-sm">
                                                                {errors.purpose}
                                                    ...
                                                    {selectedPurpose ===
                                                        ...
                                                        <div className="space-y-2">
                                                            <Field>
                                                                <FieldLabel htmlFor="custom_purpose" className="text-sm md:text-base">
                                                                    Please specify *
                                                                </FieldLabel>
                                                                <Input
                                                                    id="custom_purpose"
                                                                ...
                                                                />
                                                                <FieldDescription className="text-xs md:text-sm">
                                                                    Provide more details about your purpose.
                                                                </FieldDescription>
                                                            </Field>
                                                        </div>
                                                    )}
                                    ...
                                    <CardContent className="space-y-3 md:space-y-4">
                                        <div className="space-y-2">
                                            <div className="flex justify-between text-xs md:text-sm">
                                                ...
                                                <span>{selectedType.price_label}</span>
                                            </div>
                                            <div className="flex justify-between text-xs md:text-sm">
                                                <span className="text-muted-foreground">
                                                    Quantity:
                                            ...
                                            {calculateAmount() !== request.amount && (
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-2 md:space-y-3">
                                        <div className="flex items-center gap-2 text-xs md:text-sm">
                                            ...
                                            <span>Processing time: {selectedType.processing_time}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-xs md:text-sm">
                                            <CheckCircle2 className="h-3 w-3 md:h-4 md:w-4 text-green-500 flex-shrink-0" />
                                            <span>Digital delivery available</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-xs md:text-sm">
                                            <CheckCircle2 className="h-3 w-3 md:h-4 md:w-4 text-green-500 flex-shrink-0" />
                            ...
                            <Card>
                                <CardHeader className="pb-3 md:pb-4">
                                    ...
                                    <CardDescription className="text-xs md:text-sm">
                                        If you have questions about editing your request,
                                ...
                                <CardContent className="px-4 md:px-6">
                                    <ItemGroup>
                                        <Item className="py-2 md:py-3">
                                            <ItemMedia>
                                                <Edit3 className="h-3 w-3 md:h-4 md:w-4 text-muted-foreground" />
                                            </ItemMedia>
                                            <ItemContent>
                                                <ItemDescription className="text-xs md:text-sm">
                                                    You can only edit requests that are pending payment
                                                </ItemDescription>
                                            </ItemContent>
                                        </Item>
                                        <Item className="py-2 md:py-3">
                                            ...
                                            <ItemContent>
                                                <ItemDescription className="text-xs md:text-sm">
                                                    Changing document type or quantity will update the total cost
                                                </ItemDescription>
                                            </ItemContent>
                                        </Item>
                                        <Item className="py-2 md:py-3">
                                            ...
                                            <ItemContent>
                                                <ItemDescription className="text-xs md:text-sm">
                                                    Processing times may vary based on document type
                                                </ItemDescription>
                                            </ItemContent>
                                        </Item>
                                    </ItemGroup>
