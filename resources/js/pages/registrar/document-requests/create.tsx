                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                        ...
                        <div className="flex items-center gap-2 self-start sm:self-center">
                            <Badge variant="outline" className="gap-1 text-xs md:text-sm">
                                ...
                                <span className="hidden sm:inline">{documentTypes.length} Types Available</span>
                                <span className="sm:hidden">{documentTypes.length} Types</span>
                            </Badge>
                        </div>
                    </div>
                                ...
                                <CardContent className="space-y-3 md:space-y-4">
                                    ...
                                    {hasReachedLimit ? (
                                        <Alert variant="destructive" className="text-xs md:text-sm">
                                            ...
                                            <AlertTitle className="text-xs md:text-sm">Daily Limit Reached</AlertTitle>
                                            <AlertDescription className="text-xs md:text-sm">
                                                The maximum number of document requests (
                                                {dailyLimit}) for today has been reached.
                                        ...
                                        <Alert className="text-xs md:text-sm">
                                            ...
                                            <AlertDescription className="text-xs md:text-sm">
                                                You have {remaining} request{remaining === 1 ? '' : 's'} remaining today.
                                            </AlertDescription>
                                        </Alert>
                                    ) : null}
                                </CardContent>
                                            ...
                                            <div className="space-y-6 md:space-y-8">
                                                ...
                                                <div className="space-y-3 md:space-y-4">
                                                    ...
                                                    <Field>
                                                        ...
                                                        >
                                                            <SelectTrigger id="document_type" className="h-10 md:h-11">
                                                        ...
                                                        {selectedType && (
                                                            <FieldDescription className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-4 text-xs md:text-sm">
                                                                <span className="flex items-center gap-1">
                                                                    <Clock className="h-3 w-3" />
                                                                    Processing time: {selectedType.processing_time}
                                                                </span>
                                                                <span className="flex items-center gap-1">
                                                ...
                                                <div className="space-y-3 md:space-y-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent className="max-w-xs">
                                                                <p className="text-xs md:text-sm">
                                                                    Select or specify the purpose of your request
                                                                </p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <Field>
                                                        ...
                                                        <Select
                                                            ...
                                                            disabled={hasReachedLimit}
                                                        >
                                                            <SelectTrigger id="purpose" className="h-10 md:h-11">
                            ...
                            <Card>
                                <CardHeader className="pb-3 md:pb-4">
                                    ...
                                    <CardDescription className="text-xs md:text-sm">
                                        If you have questions about document types or the request process,
