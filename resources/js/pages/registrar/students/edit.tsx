...
export default function StudentEdit({ student }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.put(route('registrar.students.update', student.id), form);
    };

    return (
        <AppLayout>
            <Head title={`Edit ${student.last_name}, ${student.first_name}`} />
            <div className="flex flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold flex items-center gap-2"><GraduationCap className="h-6 w-6" /> Edit Student: {student.last_name}, {student.first_name}</h1>
                </div>
                    ...
                    <CardContent className="pt-6">
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-4 pt-4">
                                ...
                                <Button type="submit"><Save className="mr-2 h-4 w-4" /> Update Student</Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
