            ...
            <div className="flex-1 space-y-6 p-6 md:p-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Comprehensive overview of all modules and system
                            performance
                        </p>
                    </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                +{systemStats.new_users_in_period} in last{' '}
                                {period} days
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {systemStats.audit_logs_in_period}
                            </div>
                            <p className="text-xs text-muted-foreground">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-4 gap-2 text-center text-sm">
                                <div className="rounded-lg bg-amber-50 p-2 dark:bg-amber-950">
                                    ...
                                    <p className="mt-1 font-semibold">
                                        {registrarStats.pending_payment}
                                    </p>
                                    <p className="text-xs text-muted-foreground">
                                        Pending
                                    </p>
                                ...
                                <div className="rounded-lg bg-green-50 p-2 dark:bg-green-950">
                                    ...
                                    <p className="mt-1 font-semibold">
                                        {registrarStats.ready_for_claim}
                                    </p>
                                    <p className="text-xs text-muted-foreground">
                                        Ready
                                    </p>
                            ...
                            {registrarStats.by_document_type &&
                                registrarStats.by_document_type.length > 0 && (
                                    <div>
                                        ...
                                        >
                                            <BarChart
                                                data={registrarStats.by_document_type.slice(
                                                    0,
                                                    5,
                                                )}
                                                layout="vertical"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="rounded-lg border p-3">
                                    ...
                                    <p className="text-xl font-bold">
                                        {sasStats.total_insurance}
                                    </p>
                                </div>
                            </div>
                            {sasStats.recipients_by_scholarship &&
                                sasStats.recipients_by_scholarship.length >
                                    0 && (
                                    <div>
                                        <p className="mb-2 text-sm font-medium">
                                        ...
                                        >
                                            <PieChart>
                                                <Pie
                                                    data={sasStats.recipients_by_scholarship.slice(
                                                        0,
                                                        5,
                                                    )}
                                                    dataKey="count"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="rounded-lg border p-3">
                                    ...
                                    <p className="text-xl font-bold text-green-600">
                                        {usgStats.published_announcements}
                                    </p>
                                </div>
                                <div className="rounded-lg border p-3">
                                    <p className="text-sm text-muted-foreground">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="rounded-lg border p-3">
                                    ...
                                    <p className="text-xl font-bold">
                                        {votingStats.avg_rating > 0
                                            ? votingStats.avg_rating.toFixed(1)
                                            : 'N/A'}
                                        {votingStats.avg_rating > 0 && (
