...
export default function Create() {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('research.admin.publications.store'));
    };
                    ...
                    <CardContent>
                        <form onSubmit={submit} className="space-y-4">
                            <div>
                                ...
                                <Input id="title" value={data.title} onChange={(e) => setData('title', e.target.value)} placeholder="Publication title" />
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Input id="publication_year" type="number" value={data.publication_year} onChange={(e) => setData('publication_year', e.target.value)} placeholder="2026" />
