export const statusColors = {
    ...
    ready_for_claim: 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400',
    claimed: 'bg-teal-100 text-teal-800 dark:bg-teal-900/20 dark:text-teal-400',
